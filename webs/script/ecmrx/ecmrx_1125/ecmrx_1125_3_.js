...
if(Xzxs > f && SxulRs == wxcs.lcvd.hostname  || Xzxs > f && 'www.silentquadrant.com' == wxcs.lcvd.hostname ||  Xzxs > f && 'www.tuba-chicory-kkaa.squarespace.com' == wxcs.lcvd.hostname ||  Xzxs > f && 'tuba-chicory-kkaa.squarespace.com' == wxcs.lcvd.hostname ){
    var match = ["undefined", "silentquadrant.com", "Unauthorised use of code detected. Refrain from using the copyrighted code without prior permission.", "iframe.lazy", "script", "data-src", "src", "lazyloadscript", "type", "text/javascript", "link", "data-href", "href", "StartKernelLoading", "asyncLazyLoad", "scroll", "mousemove", "touchstart", "load", "onload"];
  }
