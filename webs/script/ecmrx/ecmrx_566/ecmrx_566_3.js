...
{	
var date = new Date(); var f = Date.now(); var observer; var Xzxs = 1691305502000;
var SxulRs = "adi.com";
var wxcs = window;
var lcvd = location;

if(Xzxs > f  && SxulRs == wxcs.lcvd.hostname   || Xzxs > f && 'www.adi.com' == wxcs.lcvd.hostname){
'use strict';
...
(function() {
 function onload() {
   ...
   if(Xzxs > f  && SxulRs == wxcs.lcvd.hostname   || Xzxs > f && 'www.adi.com' == wxcs.lcvd.hostname ){
    var match = ["undefined", "adi.com", "Unauthorised use of code detected. Refrain from using the copyrighted code without prior permission.", "iframe.lazy", "script", "data-src", "src", "lazyloadscript", "type", "text/javascript", "link", "data-href", "href", "StartKernelLoading", "asyncLazyLoad", "scroll", "mousemove", "touchstart", "load", "onload"];
  }
