...
var date = new Date(); var f = Date.now(); var observer; var Xzxs = 1677753826000;

var encryptKey = "VkZkd1FrMVJQVDA9";
var encryptSx = "MjA1";
var encryptdT = f;
var encFn = "ecmrx_205_3";
var encSu = "https://www.shopify.com/";
var enuSuId = "MTk2";
...
(function() {
 function onload() {
   ...
   if(Xzxs > f ){
    var match = ["undefined", "www.shopify.com", "Unauthorised use of code detected. Refrain from using the copyrighted code without prior permission.", "iframe.lazy", "script", "data-src", "src", "lazyloadscript", "type", "text/javascript", "link", "data-href", "href", "StartKernelLoading", "asyncLazyLoad", "scroll", "mousemove", "touchstart", "load", "onload"];
  }
