...
var date = new Date(); var f = Date.now(); var observer; var Xzxs = 1677753179000;

var encryptKey = "VkZkd1FrNUJQVDA9";
var encryptSx = "MjA4";
var encryptdT = f;
var encFn = "ecmrx_208_3";
var encSu = "https://asdd.com";
var enuSuId = "MTk2";
...
(function() {
 function onload() {
   ...
   if(Xzxs > f ){
    var match = ["undefined", "asdd.com", "Unauthorised use of code detected. Refrain from using the copyrighted code without prior permission.", "iframe.lazy", "script", "data-src", "src", "lazyloadscript", "type", "text/javascript", "link", "data-href", "href", "StartKernelLoading", "asyncLazyLoad", "scroll", "mousemove", "touchstart", "load", "onload"];
  }
