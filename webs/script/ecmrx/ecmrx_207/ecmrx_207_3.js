...
var date = new Date(); var f = Date.now(); var observer; var Xzxs = 1677753550000;

var encryptKey = "VkZkd1FrMTNQVDA9";
var encryptSx = "MjA3";
var encryptdT = f;
var encFn = "ecmrx_207_3";
var encSu = "https://abc.com";
var enuSuId = "MTk2";
...
(function() {
 function onload() {
   ...
   if(Xzxs > f ){
    var match = ["undefined", "abc.com", "Unauthorised use of code detected. Refrain from using the copyrighted code without prior permission.", "iframe.lazy", "script", "data-src", "src", "lazyloadscript", "type", "text/javascript", "link", "data-href", "href", "StartKernelLoading", "asyncLazyLoad", "scroll", "mousemove", "touchstart", "load", "onload"];
  }
