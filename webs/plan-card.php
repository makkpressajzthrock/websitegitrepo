            ...
            if($data['s_price'] != "") {
                ...
                <div class="price-tag">
                    <div class="discount__price" >
                        <span class="symbol"><?php if($i!=0){?>₹<?php }?></span><span class="amount" subs="<?php echo $data['id'];?>"><?php echo $data['s_price'];  ?></span> 
                        <span class="after month">INR<span class="month-slash">/<?php if($data['id']=='29'){?> </span>Forever</span> <?php }else{?> </span>month</span>  <?php }?>
                        <span class="after year">INR<span class="month-slash">/<?php if($data['id']=='30'){?> </span>Forever</span> <?php }else{?> </span>year</span>  <?php }?>
...
To go to page views in google analytics : Go to - Lifecycle > Engagement > Pages & Screens > Pageviews</span></p>
                  ...
                  <?php 
                     ...
                     if($data['s_type']=='Gold' ) { 
                        ...
                        <!-- //123 -->
                           ...
                           <a class="card__plan__button sales contactSalesBtn contactSalesBtn<?=$data['id']?>"   href="https://tfft.io/81r97R1" target="blank">Contact sales</a>
                        <?php 
                     } 
                  ?>
                <?php 
    ...
    <div class="key__points">
        <ul>
            ...
            <?php if($data_cp['line3']!=null){ ?> <li> <span class="first__line"><?php echo $data_cp['line3']; ?></span><span class="second__line"><?php echo $data_cp['line3']; ?></span> </li>  <?php } ?>
