            ...
            <?php
               ...
               while($data = $query->fetch_assoc() ) 
               {
                ...
                $data_cp = $query_cp->fetch_assoc();
                       ...
                       ?>
            <div class="other month__plan__card plan__card <?php if($data['name']=="Booster Plan"){echo "popular";}  ?>
               ">
               <div class="top__area col__fix">
                  ...
                  <div class="price" id="pricePlan">
                     <div class="discount__price">
                        $<span class="amount<?php echo $data['id'];?>" ><?=$data['other_country_price']?></span>
                  ...
                  <div class="popular__text" >Most Popular 40% discount</div>
            ...
            <div class="other year__plan__card  plan__card <?php if($data['name']=="Booster Plan"){echo "popular";}  ?> ">
               <div class="top__area col__fix">
                  ...
                  <div class="price" id="pricePlan">
                     <div class="discount__price">
                        $<span class="amount<?php echo $data['id'];?>"><?=$data['other_country_price']?></span> 
                        <span><span class="usd_nn">USD</span> <?php if($data['name']=='Free'){echo "/ forever";}else{echo "/ year";}?></span>
                        <span class="d-none">/<?=strtoupper($data['interval'])?></span>
                     </div>
                     <div class="actual__price">
                        <?php if($data['main_p'] != $data['s_price'] ){   ?>                                     
