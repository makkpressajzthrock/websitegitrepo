...
// echo $plan_type;
        ...
        if($d['country'] !=""){
            if($d['country'] != "101"){
                header("location: ".HOST_URL."plan-us.php?sid=".$_GET['sid']) ;
            die();
            }
        }
            ...
            <div class="padding-top">
                ...
                <div class="plan__switch">
                                ...
                                <div class="wrpper__plan__card second">
                                    ...
                                    <!-- <div class="label__plan__card">
                                        <label id="Select1Label" for="Select1" class="label__text__plan__card">Choose subscription plans</label>
                                    </div> -->
                                    ...
                                    <!-- <div class="no_card_r">
                                    For the free plan no card is required.
                                    </div> -->


                                </div>

                <!-- <div class="wrpper__plan__card third">
                ...
                <div class="alert-center-plan" >
                <?php require_once('inc/alert-message.php') ; ?>
                </div>
<!--**************** Start: Subscription Monthly *****************-->
            <div class="plan_main_container month ">
                <!-- <div class="wrpper__plan__card">

                <div class="pricing-tabs-menu w-tab-menu row monthly_tabbers col-8" role="tablist">
                  <a class="pricing-tab col-4 <?php if($current_plan_frequency=="1 Website"){echo 'active';}?>" id="tab-1" href="#m-tabs-1">
                    <div class="tab-name web">1 Website only</div>
                  </a>
                  <a class="pricing-tab col-4 <?php if($current_plan_frequency=="2 Websites"){echo 'active';}?>" id="tab-2" href="#m-tabs-2">
                    <div class="tab-name web">2 Websites <span class="green-text">(Extra 5% Off)</span>
                    </div>
                  </a>
                  <a class="pricing-tab col-4 <?php if($current_plan_frequency=="3+ Websites"){echo 'active';}?>" id="tab-3" href="#m-tabs-3">
                    <div class="tab-name web">3+ Websites <span class="green-text">(Extra 10% Off)</span>
                    </div>
                  </a>
                </div>
            ...
            <?php  
             ...
             ?>                     
                ...
                <div class="makk-page-wrapper plan-page plan-box <?php if($plan_frequency==$current_plan_frequency){echo 'active';}?>" id="m-tabs-<?=$tab?>">
                    <div class="makk-wrapper-card">
                        ...
                        <?php
                            ...
                            $query = $conn->query(" SELECT * FROM `plans` WHERE status = 1 and interval_plan = 'month' and plan_frequency = '$plan_frequency'") ;
 ...
 <!--*************** End: Subscription Monthly ******************-->

<!--**************** Start: Subscription Yearly *****************-->
            <div class="plan_main_container year  <?php if($current_plan_interval == 'year'){echo 'active';} ?> active">
                <!-- <div class="wrpper__plan__card">

                <div class="pricing-tabs-menu w-tab-menu row monthly_tabbers col-8 p-4" role="tablist">
                  <a class="pricing-tab col-4 <?php if($current_plan_frequency=="1 Website"){echo 'active';}?>" id="year-tab-1" href="#y-tabs-1">
                    <div class="tab-name web">1 Website only</div>
                  </a>
                  <a class="pricing-tab col-4 <?php if($current_plan_frequency=="2 Websites"){echo 'active';}?>" id="year-tab-2" href="#y-tabs-2">
                    <div class="tab-name web">2 Websites <span class="green-text">(Extra 5% Off)</span>
                    </div>
                  </a>
                  <a class="pricing-tab col-4 <?php if($current_plan_frequency=="3+ Websites"){echo 'active';}?>" id="year-tab-3" href="#y-tabs-3">
                    <div class="tab-name web">3+ Websites <span class="green-text">(Extra 10% Off)</span>
                    </div>
                  </a>
                </div>
            ...
            <?php                
             ...
             ?>                     
                ...
                <div class="makk-page-wrapper plan-page plan-box <?php if($tab==1){echo 'active';}?>" id="y-tabs-<?=$tab?>">
                    <div class="makk-wrapper-card">
                        <!-- <div class="text__excul aaxa">Exclusive Launch Deal for First 1000 Users, only a few left!</div> -->
                        <div class="plan-items">
                        <?php
...
setInterval(function(){
    if ($("#check_box_plan").prop('checked')==true){ 
        // console.log("true");
        $(".plan_main_container").removeClass("active");
        $(".plan_main_container.year").addClass("active");
    }   
...
function checkcountry(uc){
    ...
    if(uc=="IN" || uc =="India"){
         ...
         window.location.href="<?=HOST_URL?>plan-us.php"+window.location.search
