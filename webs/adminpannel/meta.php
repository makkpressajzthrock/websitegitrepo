...
//  $inst ="INSERT INTO `add_meta`(`id`, `title`, `keyword`, `descripton`, `pageurl`) VALUES ('$metatitle','$Metakeyword','Metadescripton','$pageurl')";
	...
	<body class="custom-tabel">
		<div class="d-flex" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<!-- Page content-->
				<div class="container-fluid content__up meta_ls">
					<h1 class="mt-4"> Meta Details</h1>
					

                	
<div class="profile_tabs">
<a href="<?=HOST_URL?>adminpannel/add-meta-detail.php" class="Polaris-Button">
                    <button type="button" class=" btn btn-primary "> Add Meta</button>
                </a>
					<div class="table_S">
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js" ></script>
  ...
  <script> 
	 ...
	 function delete_tex(btn){



	 	var tax_id=$(btn).attr("data-tax");
	 	var confirm_box=confirm("do you want to delete this data?");
	 	if(confirm_box==true){
	 		// console.log("ok");
