...
<!--  Start tab 1 -->
		...
		// echo 	$pagespeed_data["id"];
						...
						?>		
								...
								<p>You can visit <a href="https://pagespeed.web.dev/" target="_blank">https://pagespeed.web.dev/</a> to verify this data (There might be a small difference depending on your internet speed)</p>
						   ...
						   <div id="step3" class="form-tab  <?php if($installation >=3){echo "complited";}else{echo " d-none ";}?>">
							<div class="tabs-3-head tabs-head" tab="tabs-3">
							 ...
							 <div class="tabs-3 form-tab-"  style="<?php if($installation != 3){echo "display:none";}?>">
										 ...
										 <h5>1.a) Add this script code, before closing the '&lt;/head&gt;' tag in your theme,</h5>		
							 ...
							 <div class="tabs-6 form-tab-"  style="<?php if($installation !=6){echo "display:none";}?>">
								  <div class="request">
								  		<div class="status-icon">
								  			<img src="../adminpannel/img/status.png"/>	
								  		</div>
								  		<label class="status"> <span id="status_request"><?php if($status_request == 0){ echo "Pending";}else {echo "Complited";}  ?></span></label>
...
<?php if($status_request == 3) { ?>
						...
						<div class="inst_speed_new-container">
							<span class="text" >Congratulation your website is loading faster now - </span>
								 <div class="inst_speed">
...
swalWithBootstrapButtons.fire({
  title: 'Are you getting issue',
  html: '<p>Check out Installation instructions</p><br> <a class="btn btn-primary text-primary instructions__btn__install" target="_blank" href="https://help.websitespeedy.com/">Go to instructions</a><br>Generate a Installation request for installation by Website speedy team <br>',
...
$("#step4").removeClass("d-none");
			...
			Swal.fire({
				  title: 'Great!',
				  icon: 'success',
				  text: 'Congrats your have successfully added the Website Speedy Script to your website.',
