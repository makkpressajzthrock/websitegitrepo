...
$status_request = 0;
$gs_data = [] ;
$sele_sql="SELECT id , wait_for_team , status , website_id , manager_id , manager_id , status , access_requested , optimisation_is_progress FROM generate_script_request WHERE website_id ='".$project_id."' AND manager_id = '".$_SESSION['user_id']. "' ";
