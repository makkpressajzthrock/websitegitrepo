<div class="row">
	<div class="col-md-12">
		<h5>1. Add this script code, before closing the '&lt;/head&gt;' tag in header.php file,</h5>
		{{script_urls}}
	</div>
<!-- 	<div class="col-md-12 mt-5">
		<h5>2. Add also this script code, in your head tag ('&lt;head&gt; ... &lt;/head&gt;') after '&lt;meta&gt;' tag code  in your header.php file,</h5>
