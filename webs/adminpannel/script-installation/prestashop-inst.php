<div class="row">
	<div class="col-md-12">
		<h5>1.a) Add this script code, before closing the '&lt;/head&gt;' tag ,</h5>
									{{script_urls}}
		
<!-- 		<code>&lt;script type="text/javascript" src="https://ecommerceseotools.com/ecommercespeedy/es-gc.js?theme={{website_url}}"&gt;&lt;/script&gt;</code>
		  <h5>b) Add this script code,before closing the '&lt;/body&gt;' tag in footer/bottom/base file,</h5>
		<code>&lt;script type="text/javascript" src="https://ecommerceseotools.com/ecommercespeedy/es-vc.js?theme={{website_url}}"&gt;&lt;/script&gt;</code> -->
	</div>

	<!-- <div class="col-md-12 mt-5">
		<h5>2. Add this script code, in your head tag ('&lt;head&gt; ... &lt;/head&gt;') after '&lt;meta&gt;' tag code  in your header/top/base file,</h5>
		<code>&lt;script type="text/javascript" src="https://ecommerceseotools.com/ecommercespeedy/es-vc1.js?theme={{website_url}}"&gt;&lt;/script&gt;</code>
	</div>
