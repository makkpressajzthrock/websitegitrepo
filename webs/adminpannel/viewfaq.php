...
<a href="addfaq.php" class="btn btn-primary">Add Faq</a>

    	<?php  
$sql = "SELECT * FROM add_faq ORDER BY id DESC";
                ...
                <?php while($faq = mysqli_fetch_assoc($result)){ ?>
                    <tr>
                       ...
                       <td><?php echo $faq["question"]; ?></td>
                        ...
                        <td><?php         $timedy= $faq["date_created"];
                                           $vartime = strtotime($timedy);

                                             $datetimecon= date("F d, Y H:i", $vartime);  echo $datetimecon; ?></td>
                        <td>
                       <a href="faqedit.php?id=<?php echo $faq['id']; ?>"  class="btn btn-primary">
