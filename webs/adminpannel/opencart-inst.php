		...
		<div class="d-flex" id="wrapper">
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid script_I content__up">
					...
					<div class="row">
						<h3>Installation Process For OpenCart</h3>
								<div class="col-md-12">
									<!-- 	<div> <h3> Basic 
                              ...
                              <div id="copyscript">
									<!-- <h5>1.a) Add this script code, before closing the '&lt;/head&gt;' tag in header.tpl file,</h5> -->
							...
							<!-- </div> -->
								...
								<!-- <div class="col-md-12 mt-5"> -->
									<div style="display:none;"> <h3> Advanced &nbsp; <span id="toggleadvance"><i class="fa fa-chevron-up" aria-hidden="true"></i></span> </h3></div>
									 <div id="hideadvance">
									<h5>1. Add also this script code, in your head tag ('&lt;head&gt; ... &lt;/head&gt;') after '&lt;meta&gt;' tag code  in your header.tpl file,</h5>
