...
<div class="row">
	<h3>Installation Process For Shopify</h3>
	<div class="col-md-12 mt-5">
		<!-- <span style="display:none; color: green;" id="showtext"> Script Copy </span> -->
		<!--  <div> <h3> Basic 
		 	&nbsp; <span id="togglebasic"><i class="fa fa-chevron-up" aria-hidden="true"></i></span>
		 	          ...
		 	          <!-- <div id="hidebasic"> -->
                        ...
                        <div id="copyscript">
		<!-- <h5>1. Add this script code, in your head tag ('&lt;head&gt; ... &lt;/head&gt;') after '{%- render 'social-meta-tags' -%}'or {%- render 'meta-tags' -%}' code  in your theme.liquid file,</h5> -->
		<?= $script_urls ?>
		<!-- <br>
		<code>
	...
	<!-- <div class="col-md-12 mt-5"> -->
		             <div style="display:none;"> <h3> Advanced &nbsp; <span id="toggleadvance"><i class="fa fa-chevron-up" aria-hidden="true"></i></span> </h3></div>
		              <div id="hideadvance">
		<h5>1. Add also this script code, in your head tag ('&lt;head&gt; ... &lt;/head&gt;') after '{%- render 'social-meta-tags' -%}' code  in your theme.liquid file,</h5>
...
<!-- 	</div>
	<div class="col-md-12 mt-5"> -->
		<h5>5. Add this function on theme.liquid file
			before closing the head tag
		</h5>
		<code>&lt;script&gt;defer themeJsInit();&lt;/script&gt;</code> 
	<!-- </div> -->
	<!-- <div class="">
		<h5>6. And also add this before closing the head tag.<br></h5>
	...
	<!-- <div class="col-md-12 mt-5"> -->
		<h5>6. Add <b style="font-size:23px">loading="lazy"</b> in image tag for off-screen images</h5>
		<code>&lt;img src="/w3images/paris.jpg" alt="Paris" style="width:100%" <b style="font-size:23px">loading="lazy"</b>&gt;</code> 
<!-- 	</div>
	<div class="col-md-12 mt-5"> -->
		<h5>7. For Eliminate render block</h5>
