...
// checkSignupComplete($conn) ;
		$website_data = getTableData( $conn , " boost_website " , " id = '".base64_decode($_GET["project"])."' " ) ;
...
<script>
	...
	*/
	...
	$(document).ready(function() {
		...
		$(".mobile-speed").click(function() {
			$(".desktop_tabs").hide();
			$(".mobile_tabs").show();
			$(".mobile-speed").addClass("btn-primary");
			$(".mobile-speed").removeClass("btn-light");
			$(".desktop-speed").addClass("btn-light");
			$(".desktop-speed").removeClass("btn-primary");

		});
		$(".desktop-speed").click(function() {
			$(".mobile_tabs").hide();
			$(".desktop_tabs").show();
			$(".desktop-speed").addClass("btn-primary");
			$(".desktop-speed").removeClass("btn-light");
			$(".mobile-speed").addClass("btn-light");
			$(".mobile-speed").removeClass("btn-primary");
	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid  Lighthouse_Report content__up">
				...
				$mobile_categories = unserialize($pagespeed_report["mobile_categories"]);
				$mobile_audits = unserialize($pagespeed_report["mobile_audits"]);

				$ps_performance2 = round($mobile_categories["performance"]["score"] * 100, 2);
				$ps_accessibility2 = round($mobile_categories["accessibility"]["score"] * 100, 2);
				$ps_best_practices2 = round($mobile_categories["best-practices"]["score"] * 100, 2);
				$ps_seo2 = round($mobile_categories["seo"]["score"] * 100, 2);
				$ps_pwa2 = round($mobile_categories["pwa"]["score"] * 100, 2);
				...
				<div class="mobile_desktop" >
                     <div class="m_d_speed">  
					<a class="btn  btn-primary desktop-speed"><i class="las la-desktop"></i>
<span>Desktop Speed</span></a>
					<a class="btn btn-light mobile-speed"><i class="las la-mobile"></i>
<span>Mobile Speed</span></a>
				</div>


					<div class="page_speed_btn">
					<a href="<?= HOST_URL ?>adminpannel/page-speed.php?project=<?= base64_encode($project_id); ?>" class="btn btn-primary">Back</a>
				   </div>


				</div> 

				<div class=" sss profile_tabs mobile_tabs" style="display: none;">
					...
					<div class="row text-center border-bottom">
						<div class="lh-scores-container">
							...
							<div class="col-md-12 lh-scorescale">
								<div class="row">
									<div class="col-md-4"><svg xmlns="http://www.w3.org/2000/svg" fill="rgb(231 76 60)" width="18px" height="18px" viewBox="0 0 24 24">
					...
					<div class="col-md-12 border-bottom p-0 my-2">
						...
						<?php
						$fcp_color2 = getIndicator($mobile_audits["first-contentful-paint"]["score"]);
						$si_color2 = getIndicator($mobile_audits["speed-index"]["score"]);
						$lcp_color2 = getIndicator($mobile_audits["largest-contentful-paint"]["score"]);
						$cls_color2 = getIndicator($mobile_audits["cumulative-layout-shift"]["score"]);
						...
						<div class="lh-category-header">
							...
							<div>
								<h6>Metrics</h6>
								<ul>
									<li class="yellow">First Contentful Paint <span class="<?= $fcp_color2 ?>"><?= $mobile_audits["first-contentful-paint"]["displayValue"] ?></span>
									</li>
									<li class="green">Speed Index <span class="<?= $fcp_color2 ?>"><?= $mobile_audits["speed-index"]["displayValue"] ?></span>
									</li>
									<li class="yellow">Largest Contentful Paint <span class="<?= $fcp_color2 ?>"><?= $mobile_audits["largest-contentful-paint"]["displayValue"] ?></span>
									</li>
									<li class="red">Time to Interactive <span class="<?= $fcp_color2 ?>">
											<?= $mobile_audits["interactive"]["displayValue"] ?>
										</span>
									</li>
									<li class="red">Total Blocking Time <span class="<?= $fcp_color2 ?>"><?= $mobile_audits["total-blocking-time"]["displayValue"] ?></span>
									</li>
									<li class="red">Cumulative Layout Shift <span class="<?= $fcp_color2 ?>"><?= $mobile_audits["cumulative-layout-shift"]["displayValue"] ?></span>
									</li>
								</ul>
								...
								<div class="lh-metrics__disclaimer">
									...
									?>
									<p>Values are estimated and may vary. The <a href="https://web.dev/performance-scoring/" target="_blank">performance
											score is calculated</a> directly from these metrics. <a href="https://googlechrome.github.io/lighthouse/scorecalc/#FCP=5094&SI=14865&LCP=13135&CLS=0.3&device=undefined&version=7.1.0" target="_blank">See calculator.</a>
									</p>
								</div>
							...
							<div class="lh-audit-group__header">
								<p><span>Opportunities --</span>These suggestions can help your page load faster. They
									don't <a href="https://web.dev/performance-scoring/" target="_blank">directly
							...
							<div class="lh-audit-group__header">
								...
								foreach ($mobile_categories["performance"]["auditRefs"]  as $performanceAuditRefs) {
									...
									if ((in_array($performanceAuditRefs["id"], ["first-contentful-paint", "speed-index", "largest-contentful-paint", "cumulative-layout-shift", "interactive", "total-blocking-time"]))) {
										...
										foreach ($mobile_audits as $da_key => $da_value) {
								...
								?>
												<div class="accordion red">
													<?= $da_value["title"] ?>
													<div class="progress_b"><span class="progress_bar <?= $background_indicator ?>" style="width: <?= $progress_bar ?>%;"></span><span class="<?= $color_indicator ?>">
...
<!-- ----------------------------------------------------------------------------------------------------------------------- -->
						...
						<div class="lh-category-header accessibility_s">
							...
							<div class="lh-category-header__description">
								These checks highlight opportunities to <a href="https://web.dev/accessibility/" target="_blank">improve the accessibility of your
							...
							<div class="lh-audit-group__header">
								...
								foreach ($mobile_categories["accessibility"]["auditRefs"]  as $performanceAuditRefs) {
								...
								?>
											...
											<div class="panel">
												<div class="audit-group__header_s">
													<p>Low-contrast text is difficult or impossible for many users to read. <a rel="noopener" target="_blank" href="https://web.dev/image-alt">Learn
															more</a></p>
												</div>
												<div class="audit-group__header_s">
...
<!-- ----------------------------------------------------------------------------------------------------------------------- -->
						...
						<div class="lh-category-header lh-gauge__percentage">
							...
							<div class="lh-audit-group__header">
								...
								foreach ($mobile_categories["best-practices"]["auditRefs"]  as $performanceAuditRefs) {
						...
						<div class="lh-category-header lh-gauge__percentage">
							<div class="text-center">
								...
								<p>These checks ensure that your page is following basic search engine optimization
									...
									affect your search ranking, including performance on <a href="https://web.dev/learn-core-web-vitals" target="_blank">Core Web
										Vitals</a>. <a rel="noopener" target="_blank" href="https://support.google.com/webmasters/answer/35769">Learn more</a></p>
							</div>
							...
							<div class="lh-audit-group__header">
								...
								foreach ($mobile_categories["seo"]["auditRefs"]  as $performanceAuditRefs) {
						...
						<div class="lh-category-header lh-gauge__percentage">
							<div class="text-center">
								...
								<h6>Progressive Web App</h6>
								<p>These checks validate the aspects of a Progressive Web App. <a rel="noopener" target="_blank" href="https://developers.google.com/web/progressive-web-apps/checklist">Learn
										more</a></p>
							</div>
							...
							<div class="lh-audit-group__header">
								...
								foreach ($mobile_categories["pwa"]["auditRefs"]  as $performanceAuditRefs) {
							...
							<div> <strong>Additional items to manually check -</strong>
								<?php echo  htmlspecialchars($mobile_categories["pwa"]["manualDescription"]); ?>
							</div>
				...
				<div class="profile_tabs desktop_tabs">
					<div class="row text-center border-bottom">
						<div class="lh-scores-container">
							<div class="col-md-2">
								<div class="rating">
					...
					<div class="col-md-12 border-bottom p-0 my-2">
						...
						<div class="lh-category-header">
							...
							<div>
								<h6>Metrics</h6>
								<ul>
									<li class="yellow">First Contentful Paint <span class="<?= $fcp_color ?>"><?= $desktop_audits["first-contentful-paint"]["displayValue"] ?></span>
									</li>
									<li class="green">Speed Index <span class="<?= $fcp_color ?>"><?= $desktop_audits["speed-index"]["displayValue"] ?></span>
									</li>
									<li class="yellow">Largest Contentful Paint <span class="<?= $fcp_color ?>"><?= $desktop_audits["largest-contentful-paint"]["displayValue"] ?></span>
									</li>
									<li class="red">Time to Interactive <span class="<?= $fcp_color ?>">
											<?= $desktop_audits["interactive"]["displayValue"] ?>
										</span>
									</li>
									<li class="red">Total Blocking Time <span class="<?= $fcp_color ?>"><?= $desktop_audits["total-blocking-time"]["displayValue"] ?></span>
									</li>
									<li class="red">Cumulative Layout Shift <span class="<?= $fcp_color ?>"><?= $desktop_audits["cumulative-layout-shift"]["displayValue"] ?></span>
									</li>
								</ul>
