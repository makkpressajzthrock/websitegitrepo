			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid content__up script_inst_pay">
					...
					<div class="responsive profile_tabs">
						<div class="table_S">
						<table class="table script_installation_payment__table" id="mytable">
							<thead>
								<tr>
									<td>S No.</td>
									<td>Manager Name</td>
							...
							$check_installation_data =getTableData( $conn , " generate_script_request " , " 1 " , " order by id desc" , 1 ) ;
								...
								foreach ($check_installation_data as $key => $value) {
									...
									$is_subscription = getTableData( $conn , " user_subscriptions " , "id='".$boost_website['subscription_id']."' " );
								...
								?>
									<tr>
										...
										<td><span class="<?php echo str_replace(" ",'',$stats);?>"><?php echo $stats;?></span></td>
