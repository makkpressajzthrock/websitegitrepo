...
if ( isset($_POST["save-changes"]) ) {
	...
	//  || empty($phone)
	if ( empty($fname) || empty($lname) || empty($add1) || empty($city) || empty($state) || empty($zipcode) || empty($country) ) {
		$_SESSION['error'] = "Please fill all fields!" ;
		//die("1");
	}
	else 
	{
		// $admin_users_data1 = getTableData($conn, " admin_users ", " id ='" .$_SESSION['user_id']. "' ");
				...
				<div class="container-fluid manager_setting">
					...
					<div id="custom_nav">
						<ul class="menu profile_tabs">
							<li><a href="?active=profile" id="profile" ><button type="button" data-select="Profile" class=" nav_btn nav_btn1 "><i class="las la-user"></i><Span>Profile<span></button></a></li>
								<?php
						...
						<div class="row">
							...
							<form method="POST">
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="zipcode" name="zipcode" minlength="3" maxlength="10" required value="<?=$row["zipcode"]?>">
								</div>
