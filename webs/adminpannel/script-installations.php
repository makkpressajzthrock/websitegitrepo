...
<div class="col-md-12" id="page-speed-table" data-project="<?=$website_data['id']?>" data-type="page-speed">
			...
			<div class="url-speed-tables" <?php if ( ($request_manual_audit == 1 && $request_score_difference == 'All') || ($show_step2_tables == 0) ) { echo "style='display:none;'" ; } ?> >
				...
				<div class="inst_speed_new-container" >
					...
					<div class="btn_group">
						...
						<button class="<?=$optimize_more_speed?> optimize-speed-btn" data-fstep="1" data-plaform="0" data-next="4">Activate Expert Optimization (Go to Step 4)</button>
	...
	<div id="step4" class="form-tab <?php if($installation >=4){echo "complited";}else{echo " d-none ";}?>">
		...
		<div class="tabs-4-head tabs-head" tab="tabs-4">
			...
			<span class="text"> Activate Expert Optimization </span>
			<span class="icon"><i class="las la-angle-down"></i></span>
		</div>
			...
			// else {
				...
				<div class="request">
					...
					<span class="step4-manual-audit-request" <?php if(!empty($hst_active)){ echo "style='display:none;'"; } ?> >
						<p>Request WebsiteSpeedy Experts to Perform a manual Audit and make optimizations on my website to further speed improvement.</p>
						<button  class="<?php if($request_sent==0){echo "alert-pop";}else{echo "request_sent";}?> tabs-5-request btn btn-primary" data-subject="Manual Audit By Team" >Activate Expert Optimization (Free)</button>
					</span>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  function handleWindowSizeChange(mediaQuery) {
    if (mediaQuery.matches) {
      $(".acc_mob").click(function(){
        $(".accordion_sn").slideToggle();
      });
    } else {
    }
  }
