...
if ( isset($_POST["action"]) && ($_POST["action"] == "check-additional-speed-mobile") ) {
	...
	$data = google_page_speed_insight($website_url,"mobile") ;
...
if ( isset($_POST["action"]) && ($_POST["action"] == "check-additional-speed-mobile-nospeedy") ) {
