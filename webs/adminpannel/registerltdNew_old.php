		...
		<div class="d-flex" id="wrapper">
			...
			<div class="appsuno_container">
				<div class="appsuno_left">
					<div class="logo">
						<a href="https://websitespeedy.com/" ><img src="../img/signup_logo.png" alt="Website Speedy Logo"></a>
					</div>
...
<br>
After registration please <a class="bold__link" style="text-transform: capitalize;" href="https://websitespeedy.com/adminpannel/">click here</a> to login.
<br>
...
<p>In your Dashboard, click add code Button on top right to activate the deal.</p>
				...
				<div class="container-fluid  appsuno_right">
					...
					<form class="registerform" method="post">
					   	...
					   	<!---->
					   	<div class="fv-row "><label class="form-label fw-bolder text-dark fs-6">First Name<span class="madetory__star" >*</span></label><input class="form-control form-control-solid" type="text" placeholder="Enter your first name" name="fname" required="" required></div>
					   	<div class="fv-row ">
					   		<label class="form-label fw-bolder text-dark fs-6">Last Name<span class="madetory__star" >*</span></label>
						...
						<div class="fv-row full__col__grid">
							<div class="row">
								<div class="col-4">
									<label for="country_code" class="form-label fw-bolder text-dark fs-6">Contact Number
                                        <!-- <span class="madetory__star" >*</span> -->
                                    </label>
					   	...
					   	<div class="fv-row full__col__grid"><label class="form-label fw-bolder text-dark fs-6">Email<span class="madetory__star" >*</span></label><input class="form-control form-control-solid" type="email" placeholder="Enter your email" name="email" required="" required></div>
                        ...
                        <div class="fv-row full__col__grid">
                            <div class="row">
                                <div class="col-12">
                                    <label for="country_code" class="form-label fw-bolder text-dark fs-6">Where did you buy the LTD from?<span class="madetory__star" >*</span></label>
                                    <div class="for__arrow">
                                        <select id="ltd_from" name="ltd_from" class="form-control form-control-solid" required>
					   	...
					   	<div class="text-center full__col__grid"><a class="bold__link text-muted me-3 text-decoration-none" href="https://websitespeedy.com/adminpannel/">Already registered? Login Here</a></div>
					</form>							
				</div>
	...
	$('.formsubmit').click(function(){
        $.ajax({
            ...
            success: function (response) {
            	...
            	{
                    $(".alert-status").html('<div class="alert alert-success alert-dismissible fade show" role="alert">Registered Successfully. Click Here to <a href="https://websitespeedy.com/adminpannel/" class="bold__link" style="text-transform: capitalize;">Login</a>. <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>') ;
					     ...
					     $.ajax({
					      ...
					      encode: true,
					       ...
					       window.location.href = "https://websitespeedy.com/adminpannel/";
					    }).fail(function(data){
					       window.location.href = "https://websitespeedy.com/adminpannel/";
						});
