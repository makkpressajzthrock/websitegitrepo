...
// PHP code for PDF generation and email sending
         if($subscrData['plan_id'] =='29' || $subscrData['plan_id'] =='30'){
            ...
            if (!empty($subscr_id)) {
               ...
               <tr><td style='padding:8px 8px 8px 15px; width:50%;'>Paid Amount:</td><td>$paid_amount INR</td></tr>
               ...
               <tr><td style='padding:8px 8px 8px 15px; width:50%;'>Amount: </td><td>$plan_amount INR</td></tr>
