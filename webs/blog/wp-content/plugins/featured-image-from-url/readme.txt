...
= 4.5.0 =
* New feature: Auto set featured image from custom field; fix: quick editor (fatal error for some WooCommerce variable products).

= 4.4.9 =
* Enhancement: Featured video (supports Spotify and SoundCloud URLs now); enhancement: Featured image (integration with SlotsLaunch plugin); enhancement: Auto set featured image using post title and search engine (tips for achieving better results have been added); fix: quick editor (not working for WooCommerce categories).

= 4.4.8 =
* Enhancement: quick editor (supports variable products now); enhancement: FIFU Settings page (refreshes after 10 minutes to avoid issues with expired sessions).
