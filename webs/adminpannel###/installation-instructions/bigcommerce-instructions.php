...
<div class="row mb-4">
	<h3>Installation Process For BigCommerce</h3>
	<div class="col-md-12">
		<!--  <div> <h3> Basic
		  &nbsp; <span id="togglebasic"><i class="fa fa-chevron-up" aria-hidden="true"></i></span>
		 	   ...
		 	   <!-- <div id="hidebasic"> -->
                        ...
                        <div id="copyscript">
		<!-- <h5>1. Add this script code, before closing the '&lt;/head&gt;' tag in base.html file,</h5> -->
		<?= $script_urls ?>
	</div>
</div>
<!-- </div> -->
	<!-- <div class="col-md-12 mt-5"> -->
		         <div style="display:none;"> <h3> Advanced &nbsp; <span id="toggleadvance"><i class="fa fa-chevron-up" aria-hidden="true"></i></span> </h3></div>
		          <div id="hideadvance">
		<h5>1. Add also this script code, in your head tag ('&lt;head&gt; ... &lt;/head&gt;') after '&lt;meta&gt;' tag code  in your base.html file,</h5>
