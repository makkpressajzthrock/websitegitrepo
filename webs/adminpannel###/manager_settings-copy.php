						...
						<div class="form-group">
							...
							<?php
								...
								foreach ($list_countries as $key => $country_data) {
									...
									?><option value="<?=$country_data["id"]?>" <?=$selected?> ><?=$country_data["name"]?></option><?php
								}
							?>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<?php
								...
								foreach ($list_states as $key => $state_data) {
									...
									?><option value="<?=$state_data["id"]?>" <?=$selected?> ><?=$state_data["statename"]?></option><?php
								}
							?>
							</select>
						</div>
						...
						<div class="form-group">
							...
							<?php
								...
								foreach ($list_cities as $key => $city_data) {
									...
									?><option value="<?=$city_data["id"]?>" <?=$selected?> ><?=$city_data["cityName"]?></option><?php
								}
							?>
							</select>
						</div>
