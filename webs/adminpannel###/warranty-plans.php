...
<?php require_once("inc/style-and-script.php") ; ?>
	...
	<body class="custom-tabel">
		...
		<div class="top-bg-img"></div>
			...
			<div id="page-content-wrapper">
				...
				<!-- Page content-->
				<div class="container-fluid warranty_plan content__up">
					<h1 class="mt-4"> Warranty plans</h1>
					<?php require_once("inc/alert-status.php") ; ?>
					
				    <div class="profile_tabs">
					<a href="<?=HOST_URL?>adminpannel/warranty-plan-add.php" class="btn btn-primary">Add New Plan </a>


					 			<?php
						$select = " select * from plans_warranty";
					...
					<div class="table_S">
					<table class="table speedytable" id="warranty_datatable">
					  ...
					  <tbody>
						...
						if ( $ac == 0 ) {
							...
							<tr class="row<?php echo $planss['id'];?>">
	
						           
								<td><?php echo $planss['id'];?></td>
  ...
  $(document).ready( function () {
		$('#warranty_datatable').DataTable();
  });

	 function delete_plan(btn){



	 	var plan_id=$(btn).attr("data-plan_id");
	 	var confirm_box=confirm("do you want to delete this file?");
	 	if(confirm_box==true){
	 		// console.log("ok");
	 	
	 	 	
		    $.ajax({
		        url: "warranty-plan-delete.php",
		        type: "POST",
		    	  dataType: "json",
		        data: {
		            plan_id: plan_id,
