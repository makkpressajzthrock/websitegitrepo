		...
		<div class="top-bg-img"></div>
			...
			<div id="page-content-wrapper">
				...
				<div class="container-fluid content__up sumo_code">
					<h1>DealFuel coupon code</h1>
					<?php require_once("inc/alert-status.php") ; ?>
					<div class="profile_tabs">
					<div class="download_csv">
						<button type="button" class="csv_generate btn btn-primary" id="csv_generate"><a href="generateCsvdealFule.php">Download CSV</a></button><br>
					</div>
					...
					<div class="table_S">
						<table id="mytable" class="table">
							...
							<tbody>
					<?php
						$fetchCode = "SELECT * FROM deal_fuel";
		...
		<?php
			if (isset($_POST['sumo_generate'])) 
			{
			    ...
			    for ($i = 0; $i <$count_of_code; $i++) 
			    {
					...
					$Code =  bin2hex($bytes);
				$insertcode = "INSERT INTO deal_fuel(`code`,`date`) VALUES('$Code','$date')";
