		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid content__up view_payments">
				...
				<table class="table speedytable view_payment_d">
					...
					<tr>
						<th>Paid Amount</th>
						<td><?php echo number_format($run_qry['amount']/100,2).' '.strtoupper($run_qry['currency']); ?> </td>
					</tr>
					<tr>
