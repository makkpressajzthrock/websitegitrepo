<?php 
include('config.php');
header("Location: ".HOST_URL."adminpannel/registerltdNew.php");
exit;
				...
				<div class="container-fluid  appsuno_right">
					...
					<form class="registerform" method="post">
						...
						<div class="fv-row full__col__grid">
							<div class="row">
								<div class="col-4">
									<label for="country_code" class="form-label fw-bolder text-dark fs-6">Contact Number<span class="madetory__star" >*</span></label>
                        ...
                        <!-- <div class="fv-row full__col__grid">
					   	...
					   	<div class="fv-row full__col__grid"><label class="form-label fw-bolder text-dark fs-6">LTD code<span class="madetory__star" >*</span></label><input class="form-control form-control-solid" type="text" placeholder="Enter your LTD code" 
