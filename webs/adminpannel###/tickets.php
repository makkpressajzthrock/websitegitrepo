		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid content__up tickets_a">
                ...
                <div class="profile_tabs">
					...
					<div class="table_S">
				<table class="speedy-table table " id="speedy-table-id">
					<thead>
						<tr>
							<th>S.No</th>
							<th>Ticket ID</th>
					...
					<tbody>
						<?php
							...
							$tickets = getTableData( $conn , " support_tickets " , "" , "" , 1 ) ;
							...
							if ( count($tickets) > 0 ) 
							{
								...
								foreach ($tickets as $tickets_data) {
									...
									$replycheck = $replycheck->fetch_assoc()['manager_id'];


									$client_replied = ( $replycheck != 1 && $replycheck != null )?1:0;
						...
						<tr>
							...
							<td>
								<?=($tickets_data['resolved']==1)?'Resolved':'Unresolved'?>
							</td>
							<td><a href="admin_ticket_reply.php?ticket_id=<?=base64_encode($tickets_data['id'])?>"><button
										type="button" class="btn btn-success">
										<?php if($replycheck != null) { ?>
										<?=($client_replied == 1)?'Client Replied':'Reply'?>
										<?php }else{ echo 'New Ticket';} ?>
									</button></a></td>
						</tr>
						<?php
									$sno++ ;
