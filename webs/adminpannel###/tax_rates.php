	...
	<body class="custom-tabel">
		...
		<div class="top-bg-img"></div>
			...
			<div id="page-content-wrapper">
				...
				<!-- Page content-->
				<div class="container-fluid content__up tax_rates">
					<h1>Tax rates</h1>
					<?php require_once("inc/alert-status.php") ; ?>
					<div class="profile_tabs">
					<a href="<?=HOST_URL."adminpannel/add-tax.php" ?>" class="btn btn-primary ">Add Tax </a>
														
				<?php

							
						
	                    $qrys = "select * from `add-tax` ";
						 
						$connect_qrys= mysqli_query($conn, $qrys);
