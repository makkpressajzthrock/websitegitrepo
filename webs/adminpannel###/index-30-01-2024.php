...
<div class="container login_wrapper" id="passhide">
<div class="glass"></div>
<div class="glass"></div>
<div class="glass"></div>
<div class="glass"></div>
...
<div class="glass"></div>
        ...
        <form method="post">
        <div class="pass_logo">
 <img src="./img/sitelogo_s.png">
</div>
  <div class="form-group">
    <label>Password </label>
    <input type="password" class="form-control" id="exampleInputPassword1" name="passwrod" placeholder="Password">
  </div>
...
<div class="register-page">
  ...
  <div class="logo-header">
            <a href="https://websitespeedy.com/" ><img alt="Website Speedy Logo" id="loginimg" src="<?=HOST_URL?>adminpannel/img/signup_logo.webp"></a>
</div>
...
<h2 class="heading">Login</h2>
           <?php include("inc/alert-status.php") ; ?>
                ...
                <label class="lable-design" for="email">Email address</label>
                    <input class="input-design" type="email" name="username" placeholder="Email" autofocus required></input>
                </div>
                <div class="form-input">
                <label class="lable-design"  for="password">Password</label>
                    ...
                    <div class="icon-show-pass" onclick="show(this)">
							<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><rect width="100%" height="100%" fill="none"/><path d="M128,56C48,56,16,128,16,128s32,72,112,72,112-72,112-72S208,56,128,56Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/><circle cx="128" cy="128" r="40" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="16"/></svg>
							<svg class="show slash" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path fill="#212529" d="M17.3196 2.49221L8.50731 22.3198L6.67969 21.5076L15.492 1.67993L17.3196 2.49221Z" fill="black"/></svg>
							</div>
                </div>
      ...
      <p class="copyright">Copyright © 2023 <a href="https://websitespeedy.com/">Websitespeedy</a> All rights reserved.</p>
    </div>
  </div>
  <div class="register-detail">
    ...
    <div class="design">
        ...
        <div class="review__wrapper">
		   ...
		   <p>Rated 5 Star Across the Platforms</p>
		   <div class="logos_log">
		   <img  src="//websitespeedycdn.b-cdn.net/speedyweb/images/capterra-trans-new.webp" alt="Serchen logo" class="capterra">
		   <img src="//websitespeedycdn.b-cdn.net/speedyweb/images/trust-pilot-logo.png" alt="Trust Pilot logo" class="trust-pilot">
		   <svg class="sourceforge" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 653 102.6" style="enable-background:new 0 0 653 102.6;" xml:space="preserve">
						...
						<img src="//websitespeedycdn.b-cdn.net/speedyweb/images/software-suggest_1.webp" alt="Software Suggest logo" class="software-suggest_1" style="filter: invert(1); width:15%;">
		   </div>
