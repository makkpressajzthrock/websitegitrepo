...
<style>
   ...
   .plan_new .new__design.card__blocks .plan__card .key__points p:nth-child(7),
   .plan_new .new__design.card__blocks .plan__card .key__points p:nth-child(6) {
padding-left:30px !important;
   ...
   .new__design.plan_new_s .plan__card .key__points p:nth-child(3), 
...
.year__plan__card .top__area .price .discount__price {
    min-height: 64.79px;
}
