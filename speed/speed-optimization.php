        ...
        <div class="main__content">
            ...
            <div class="text__area new"  >
                <div class="heading">
                    ...
                    <h1>Make your website load<br> at lightning fast speed</h1>
                </div>
                ...
                <div class="cta__wrapper"> 
                    <div>
                        ...
                        <span>No Credit Card required. Set-up in 5 minutes. </span>
                    </div>
                    <span class="or__text">OR</span>
                    <div class="only__link__a">
                    <a href="#test__section" class="test__scroll btn">Test Now</a>
                    </div>
                </div>
                ...
                <div class="rating__wrpper" >
                    ...
                    <div class="logos">
                        <a href="//www.capterra.com/p/10005566/Website-Speedy/" target="_blank"><img src="<?=$bunny_image?>capterra-trans.webp" alt="Serchen logo" class="capterra"></a>
                        <a href="//www.trustpilot.com/review/websitespeedy.com" target="_blank"><img src="<?=$bunny_image?>trust-pilot-logo.png" alt="Trust Pilot logo" class="trust-pilot"></a>
                        ...
                        <a href="//www.softwaresuggest.com/website-speedy" target="_blank"><img src="<?=$bunny_image?>software-suggest_1.webp" alt="Software Suggest logo" class="software-suggest_1"></a>
                    </div>
                </div>
            ...
            <img src="<?=$bunny_image?>shopify-platform-page.webp" alt="">
            </div>
                ...
                <div class="video-container">
                    <div class="hytPlayerWrapOuter">
                        <div class="hytPlayerWrap">
                            <iframe width="100%" height="100%" src="https://www.youtube.com/embed/NjLntJzkoDo?rel=0&enablejsapi=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>fermetournesol.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                ...
                <div class="web__wrapper load_pro_main">
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>cardwelry.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                                <div class="load_pro_bx">
                ...
                <div class="web__wrapper load_pro_main">
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>womency.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                                <div class="load_pro_bx">
                ...
                <div class="web__wrapper load_pro_main">
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>after-story.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                                <div class="load_pro_bx">
                ...
                <div class="web__wrapper load_pro_main">
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>face-camera.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                                <div class="load_pro_bx">
                ...
                <div class="web__wrapper load_pro_main">
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>jurassic-studio.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                                <div class="load_pro_bx">
                ...
                <div class="web__wrapper load_pro_main">
                    <div class="load_pro_main_inn">
                        <div class="load_pro before__bx">
                            ...
                            <div class="load_pro_wrapper_inner">
                                <img src="<?=$bunny_image?>x-special.webp" class="load_main_img" />
                                <div class="page-speed-logo">
                                    <img src="<?=$bunny_image?>page-speed.webp" class="load_main_img" />
                                </div>
                                <div class="load_pro_bx">
...
<div class="combined__wrapper zig__zag" >
            ...
            <div class="section__wrapper cmn-pdd">
                ...
                <div class="cmn-grid-bx rvrs-bx">
                    <div class="cmn-grid-img">
                        <img src="<?=$bunny_image?>risk-of-slow.webp" alt="Conversion Rate">
                    </div>
        ...
        <section class="user-experience">
            <div class="section__wrapper cmn-pdd">
                ...
                <div class="cmn-grid-bx">
                    ...
                    <div class="cmn-grid-img">
                        <img src="<?=$bunny_image?>User-Experience.webp" alt="Loading Speed">
                    </div>
                </div>
            </div>
        </section>
...
<div class="logo__section">
    <div class="section__wrapper">
        <div class="logo__section__wrapper">
            <div class="heading">
                <h2>Our <span>Script</span> is Compatible with All Major Platforms</h2>
            </div>
