...
// }
 ...
 if($_POST['planSelect']=='Select'){
    ...
    $sql = "SELECT id, name, floor(JSON_UNQUOTE(JSON_EXTRACT(list_of_price, '$.\"$price\"'))/12) AS price    FROM plans    WHERE JSON_UNQUOTE(JSON_EXTRACT(list_of_price, '$.\"$price\"')) IS NOT NULL AND id = $planId";
    $result = $conn->query($sql);
