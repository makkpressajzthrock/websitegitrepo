...
<style>
   ...
   .card__blocks.year .year__plan__card:nth-child(4) {
   order: 1;
   }
   .card__blocks.year .year__plan__card:nth-child(3) {
   order: 2;
   }
   .card__blocks.year .year__plan__card:nth-child(1) {
   order: 3;
   }
   .card__blocks.year .year__plan__card:nth-child(2) {
   order: 4;
   }
   ...
   .plan__section.new__design.plan_new_s .plan__card .key__points p:nth-child(8)::before {
   content: " ";
   ...
   .new__design.plan_new_s .plan__card .key__points p:nth-child(8) {
   ...
   .card__blocks.year .year__plan__card:nth-child(2) .sp_first{
   display:none;
   }
   ...
   .actual__price span, .discount__price span:nth-child(2),
    .year__plan__card .actual__price span, .year__plan__card .discount__price span:nth-child(2) {
   text-transform: capitalize;
   }
   .card__blocks.year .year__plan__card:nth-child(4) .top__area .btn__inverse {
   background: none !important;
   color: #333;
   transition: all 250ms ease;
   border: 2px solid #333;
   }
   .card__blocks.year .year__plan__card:nth-child(4) .top__area .btn__inverse:hover {
   outline: 1px solid #f23640;
   border-color: #f23640;
   color:#333;
   }
   .card__blocks.year .year__plan__card:nth-child(2) .actual__price del {
   display: none;
   }
   span.paid_ann {
    display: block;
...
.year__plan__card #pricePlan .discount__price {
    min-height: 64.89px;
}
            ...
            <?php
               ...
               while($data = $query1->fetch_assoc() ) 
               {
                   ...
                   $data_cp = $query_cp->fetch_assoc();
                       ...
                       ?>
            <div class="other year__plan__card  plan__card <?php if($data['name']=="Booster Plan"){echo "popular";}  ?> ">
               <div class="top__area col__fix">
                  ...
                  <?php if($data_cp['line15']!=null){   ?>
                  <p class="sub_hs"><?php echo $data_cp['line15']; ?></p>
                  <?php } ?>
                  <div class="price" id="pricePlan">
                     <div class="discount__price">
                        $<span class="amount<?php echo $data['id'];?>"><?=round($data['other_country_price']/12)?></span> 
                        <span><span class="usd_nn">USD</span> <?php if($data['name']=='Free'){echo "/ forever";}else{echo "/Month";}?></span>
                        <?php if($data['name']!='Free') { ?><span class="paid_ann">paid annually</span><?php } ?>
                        <span class="d-none">/<?=strtoupper($data['interval'])?></span>
                     </div>
                     <div class="actual__price">
                        <?php if( !empty($data['main_p']) && $data['main_p'] != $data['s_price'] ){   ?>                                     
                        <del>$<?=$data['us_main_p']?>
                        <!-- <span class="">/Month</span>  </del> -->
                        <?php } ?>       
                     </div>
                     <div class="price__changed" >
                        <div><span>$ <?=number_format($data['other_country_price'] / 12, 2)?> <span>/month</span></span></div>
                        <div>Paid Annually <span class="main_p">$<?=$data['other_country_price']?> <span>/yr</span></span> <span class="d-price">$<?=$data['us_main_p']?> <span>/yr</span></span></div>
                     </div>
                  </div>
                  ...
                  <p class="sp_first"><span>Up To <span><span><?php echo $data['page_view']; ?></span> <span><?php if($data_cp['line2']!=null){ ?><?php echo $data_cp['line2']; ?><?php } ?></span>  <span class="q__icon" >?</span><span class="text__hidden" >To get an idea about your monthly page views go to your Google Analytics Dashboard.
                     To go to page views in google analytics : Go to - Lifecycle > Engagement > Pages & Screens > Pageviews</span>
                  </p>
                  <div class="subscribe_free">
                     <div class="sub_free">
                        <a id="<?php echo str_replace(' ', '', strtolower($data['name'])); ?><?=$data['id']?>" class="btn__inverse card__plan__button getStartedBtn<?=$data['id']?>" href="/signup.php" >Get Started<i class="las la-angle-right"></i></a>
                        <?php 
                           $list_of_price = json_decode($data['list_of_price']);
                           
                           if($data['s_type']=='Gold' ) { 
                               ?>
                        <div class="pr_sd" style="order: 0;">
                           <select name="selectPricing" id="selectPricing" class="selectPricing">
                              ...
                              foreach($list_of_price as $key => $row) {
                                 ...
                                 <?php 
                                 if($key !='Unlimited' && ($key=='250000' || $key=='500000')){ echo ($key/1000)."k page views";}  
                                 if($key !='Unlimited' && $key!='250000'  && $key!='500000' ){echo ($key/1000000)." Million page views";}
                                 if($key == 'Unlimited'){ echo "I want unlimited views"; } 
                                 ?>
                                 </option>
                                 <?php  
                              } 
                        ...
                        <!-- //123 -->
                        <a class="card__plan__button sales contactSalesBtn"  style="display:none" href="https://tfft.io/81r97R1" target="blank">Contact sales</a>
                        <?php 
                           } 
                           ?>
                     </div>
               ...
               <div class="key_wrap">
                  <div class="key__points">
                     ...
                     <p><span><?php echo $data['page_view']; ?></span> <span><?php if($data_cp['line2']!=null){ ?><?php echo $data_cp['line2']; ?><?php } ?></span>  <span class="q__icon" >?</span><span class="text__hidden" >To get an idea about your monthly page views go to your Google Analytics Dashboard.
                        To go to page views in google analytics : Go to - Lifecycle > Engagement > Pages & Screens > Pageviews</span>
                     </p>
                     <?php if($data_cp['line1']!=null){ ?> 
                     <p> <span class="first__line" ><?php echo $data_cp['line1']; ?></span> <span class="second__line" ><?php echo $data_cp['line1']; ?></span></p>
                     <?php } ?>                             
                     <?php if($data_cp['line3']!=null){ ?> 
                     <p> <?php echo $data_cp['line3']; ?> </p>
                     <?php } ?>
                     <?php if($data_cp['line4']!=null){  ?>  
                     <p><?php echo $data_cp['line4']; ?></p>
                     <?php } ?>
                     <?php if($data_cp['line5']!=null){  ?> 
                     <p><?php echo $data_cp['line5']; ?></p>
                     <?php } ?>
                     <?php if($data_cp['line6']!=null){ ?>  
                     <p><?php echo $data_cp['line6']; ?></p>
                     <?php } ?>
                     <?php if($data_cp['line7']!=null){  ?> 
                     <p><?php echo $data_cp['line7']; ?></p>
                     <?php } ?>
                     <?php if($data_cp['line8']!=null){  ?> 
                     <p><?php echo $data_cp['line8']; ?></p>
                     <?php } ?>
                     <?php if($data_cp['line9']!=null){   ?>  
                     <p><?php echo $data_cp['line9']; ?></p>
                     <?php } ?>
                     <?php if($data_cp['line10']!=null){   ?>  
                     <p><?php echo $data_cp['line10']; ?></p>
                     <?php } ?>
               ...
               <div class="slide_btn">
                  <div class="flx_con">
                     <span>What’s included</span> <?xml version="1.0" ?>
                     <svg fill="none" stroke-width="1.5" viewBox="0 0 24 24" width="24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="section__wrapper">
         <div class="single__review">
            <div class="review__img" >
               <img src="<?=$bunny_image?>plan-page-image.avif" alt="">
            </div>
...
<script>
   ...
   var getData = $.getJSON('https://ipapi.co/json/', function(data) {  
       ...
       console.log(country);
       if(country=="IN"){
           window.location.href = "<?=HOST_URL?>website-speed-optimiation-cost.php";
       }
   });    
